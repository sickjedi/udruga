...
export class CustomerService {
    ...
    private convertItemFromServer(customer: Customer): Customer {
        ...
        copy.datecreated = this.dateUtils
            .convertLocalDateFromServer(customer.datecreated);
        copy.lastupdated = this.dateUtils
            .convertLocalDateFromServer(customer.lastupdated);
        return copy;
    }
    ...
    private convert(customer: Customer): Customer {
        const copy: Customer = Object.assign({}, customer);
        copy.datecreated = this.dateUtils
            .convertLocalDateToServer(customer.datecreated);
        copy.lastupdated = this.dateUtils
            .convertLocalDateToServer(customer.lastupdated);
        return copy;
    }
}
