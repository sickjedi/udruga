                    ...
                    .subscribe((customerResponse: HttpResponse<Customer>) => {
                        ...
                        if (customer.datecreated) {
                            customer.datecreated = {
                                year: customer.datecreated.getFullYear(),
                                month: customer.datecreated.getMonth() + 1,
                                day: customer.datecreated.getDate()
                            };
                        }
                        if (customer.lastupdated) {
                            customer.lastupdated = {
                                year: customer.lastupdated.getFullYear(),
                                month: customer.lastupdated.getMonth() + 1,
                                day: customer.lastupdated.getDate()
                            };
                        }
