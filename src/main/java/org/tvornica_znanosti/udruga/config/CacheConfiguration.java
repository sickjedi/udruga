...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.tvornica_znanosti.udruga.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.tvornica_znanosti.udruga.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(org.tvornica_znanosti.udruga.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(org.tvornica_znanosti.udruga.domain.Authority.class.getName(), jcacheConfiguration);
